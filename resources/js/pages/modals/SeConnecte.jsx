              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8 ">
                ...
                >
                  <div>
                    ...
                    {errors && <div className="ms-0  "><p className="text-lg text-red-500 ">{errors.email}</p></div>}
                  ...
                  <div>
                    ...
                    {errors && <div className="ms-0  "><p className="text-lg text-red-500 ">{errors.password}</p></div>}
