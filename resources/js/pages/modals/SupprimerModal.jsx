...
export default function SupprimerModal({statemodalsupprimer,cvsupprimer}) {
            ...
            <div className="w-full bg-white rounded-lg shadow border  md:mt-0 md:w-2/6 sm:w-3/6 xl:p-0">
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8 ">
                ...
                <div className="p-3  mt-2 text-center space-x-4 md:block">
                  ...
                  <button className="mb-2 md:mb-0 bg-red-500 border border-red-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-red-600" onClick={supp}>supprimer</button>
                </div>
              </div>
            </div>
          </div>
