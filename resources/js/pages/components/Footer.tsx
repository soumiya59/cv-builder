...
<footer className="mx-auto bg-white max-w-7xl sm:px-6 lg:px-8">
    ...
    <div className="px-12 sm:px-4 py-6 border-t-2 sm:flex sm:items-center sm:justify-between ">
        <span className="text-sm text-gray-500 text-center">© 2023 <a href="#">NovoCV™</a>. All Rights Reserved.
        </span>
